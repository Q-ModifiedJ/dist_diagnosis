...
data_dir = config.data_7node_dir

def collect_cpu_saturation_data_onenode(number, node):
    assert node in [0, 1, 2, 3, 4, 5, 6]
    labels = ["normal", "normal", "normal", "normal","normal","normal","normal"]
    labels[node] = "cpu"

    ob_controller = OceanBaseController()
    ob_monitor = OBMonitor(30, 5, labels=labels,server_num=7)
...
def collect_cpu_saturation_data_twonode(number, node1, node2):
    assert node1 in [0, 1, 2, 3, 4,5,6]
    assert node2 in [0, 1, 2, 3, 4,5,6]
...
def collect_io_and_cpu_saturation_data_onenode(number, node):
    ...
    ob_controller = OceanBaseController()
    ob_monitor = OBMonitor(30, 5, labels=labels,extra_label=extral_label, server_num=7)
...
def collect_cpu_saturation_and_heavyload_data_onenode(number, node):
    assert node in [0, 1, 2, 3, 4,5,6]
    labels = ["load", "load", "load", "load","load","load","load"]
    extra_label = "node{}.cpu".format(node + 1)

    ob_controller = OceanBaseController()
    ob_monitor = OBMonitor(30, 5, labels=labels, extra_label=extra_label,server_num=7)
    cpu_abnormal = CPUSaturation(node=nodes[node])
...
def cpu():
    ...
    collect_cpu_saturation_data_onenode(7, 3)
    time.sleep(20)

    print("collecting cpu node4")
    collect_cpu_saturation_data_onenode(8, 4)
    time.sleep(20)

    print("collecting cpu node5")
    collect_cpu_saturation_data_onenode(9, 5)
    time.sleep(20)

    print("collecting cpu node6")
    collect_cpu_saturation_data_onenode(10, 6)
    time.sleep(20)
...
def cpu_2():
    ...
    print("collecting cpu node0")
    collect_cpu_saturation_data_twonode(2, 0, 2)
    time.sleep(20)

    print("collecting cpu node0")
    collect_cpu_saturation_data_twonode(3, 0, 5)
    time.sleep(20)

    print("collecting cpu node0")
    collect_cpu_saturation_data_twonode(4, 5, 6)
    time.sleep(20)

    print("collecting cpu node0")
    collect_cpu_saturation_data_twonode(5, 1, 2)
    time.sleep(20)

    print("collecting cpu node0")
    collect_cpu_saturation_data_twonode(6, 1, 3)
    time.sleep(20)

    print("collecting cpu node0")
    collect_cpu_saturation_data_twonode(7, 1, 4)
    time.sleep(20)
    ...
    print("collecting cpu node0")
    collect_cpu_saturation_data_twonode(9, 3, 4)
    time.sleep(20)

    print("collecting cpu node0")
    collect_cpu_saturation_data_twonode(10, 2, 4)
    time.sleep(20)
...
def cpu_io():
    ...
    print("collecting cpu node3")
    collect_io_and_cpu_saturation_data_onenode(7, 3)
    time.sleep(20)

    print("collecting cpu node4")
    collect_io_and_cpu_saturation_data_onenode(8, 4)
    time.sleep(20)

    print("collecting cpu node5")
    collect_io_and_cpu_saturation_data_onenode(9, 5)
    time.sleep(20)

    print("collecting cpu node6")
    collect_io_and_cpu_saturation_data_onenode(10, 6)
    time.sleep(20)
...
def cpu_and_load():
    ...
    print("collecting cpu node3")
    collect_cpu_saturation_and_heavyload_data_onenode(7, 3)
    time.sleep(20)

    print("collecting cpu node4")
    collect_cpu_saturation_and_heavyload_data_onenode(8, 4)
    time.sleep(20)

    print("collecting cpu node5")
    collect_cpu_saturation_and_heavyload_data_onenode(9, 5)
    time.sleep(20)

    print("collecting cpu node6")
    collect_cpu_saturation_and_heavyload_data_onenode(10, 6)
    time.sleep(20)
